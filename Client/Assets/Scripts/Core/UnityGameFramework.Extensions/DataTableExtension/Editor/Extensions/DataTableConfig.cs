...
namespace DE.Editor {
    ...
    public class DataTableConfig : ScriptableObject {
        ...
        private static string s_DataTableConfigPath = $"Assets/Scripts/Core/UnityGameFramework.Extensions/DataTableExtension/Editor/Resource/DataTableConfig.asset";
        ...
        public static void CreateDataTableConfig()
        {
            ...
            codeGeneratorSettingConfig.ExcelsFolder = "Assets/../../ClientExcel/";
            codeGeneratorSettingConfig.CSharpCodePath = "Assets/Scripts/GameApp/Generate/TableCode";
            codeGeneratorSettingConfig.CSharpCodeTemplateFileName = "Assets/Scripts/Core/UnityGameFramework.Extensions/DataTableExtension/Editor/Resource/DataTableCodeTemplate.txt";
            codeGeneratorSettingConfig.ExtensionDirectoryPath = "Assets/Scripts/Core/UnityGameFramework.Extensions/DataTableExtension/Runtime/Extensions";
            codeGeneratorSettingConfig.NameSpace = "GameApp";
            codeGeneratorSettingConfig.ExtensionNameSpace = "UnityGameFramework.Extensions";
