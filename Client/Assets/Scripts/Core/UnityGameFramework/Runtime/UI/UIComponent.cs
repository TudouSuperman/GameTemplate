...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        public bool AddUIGroup(string uiGroupName, int depth)
        {
            ...
            Transform uiGroupTransform = uiGroupHelper.transform;
            uiGroupTransform.transform.SetParent(m_InstanceRoot);
            uiGroupTransform.localPosition = Vector3.zero;
            uiGroupTransform.localRotation = Quaternion.identity;
