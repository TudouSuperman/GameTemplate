...
namespace GameApp.UI
{
    public sealed class DialogFormLogic : UGuiFormLogic
    {
        ...
        protected override void OnOpen(object userData)
        {
            ...
            _view.RefreshConfirmText(string.IsNullOrEmpty(m_DialogParams.ConfirmText) ? GameEntry.Localization.GetString(Constant.LanguageKey.Dialog_Confirm) : m_DialogParams.ConfirmText);
            _view.RefreshCancelText(string.IsNullOrEmpty(m_DialogParams.CancelText) ? GameEntry.Localization.GetString(Constant.LanguageKey.Dialog_Cancel) : m_DialogParams.CancelText);
            _view.RefreshOtherText(string.IsNullOrEmpty(m_DialogParams.OtherText) ? GameEntry.Localization.GetString(Constant.LanguageKey.Dialog_Other) : m_DialogParams.OtherText);
