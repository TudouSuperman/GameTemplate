...
namespace GameApp.Hot.UI.Extension
{
    public sealed class ImageMirror : Image
    {
        ...
        [SerializeField]
        private EMirrorType m_MirrorType = EMirrorType.Horizontal;
        ...
        public override void SetNativeSize()
        {
            if (sprite != null)
            {
                ...
                if (MirrorType == EMirrorType.Horizontal)
                {
                    w *= 2;
                }
                else if (MirrorType == EMirrorType.Vertical)
                {
                    h *= 2;
                }
                else
