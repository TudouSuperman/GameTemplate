...
namespace GameApp.Editor
{
    ...
    {
        public static readonly string BuildPkgFolder = Path.GetFullPath("../ClientBuild/Build_Package");
        ...
        public static BuildReport BuildPkg(Platform platform)
        {
            ...
            {
                throw new GameFrameworkException($"build Package fail : { buildReport.summary.result }");
            }
            Debug.Log($"finish build Package at {locationPathName}");
