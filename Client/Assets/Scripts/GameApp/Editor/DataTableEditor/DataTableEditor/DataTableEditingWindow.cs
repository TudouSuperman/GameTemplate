...
namespace GameApp.DataTable.Editor
{
    ...
    public class DataTableEditingWindow : EditorWindow
    {
        ...
        public void OpenWindow(string path, Encoding encoding)
        {
            ...
            FilePath = path;
            RowDataList = DataTableEditorUtility.DataTableUtility.LoadDataTableFile(FilePath, m_encoding);
        ...
        private void SaveDataTable()
        {
            ...
            DataTableEditorUtility.DataTableUtility.SaveDataTableFile(FilePath, RowDataList, m_encoding);
        }
